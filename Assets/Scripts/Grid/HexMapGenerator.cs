		...
		void SetTerrainType() {
			for (int i = 0; i < cellCount; i++) {
				...
				if (!cell.IsUnderwater) {
					...
					switch ((TerrainType)cell.TerrainTypeIndex) {
						case TerrainType.Grass:
							cell.PlantLevel = Random.Range(0, 4); break;
						case TerrainType.Mud:
							cell.PlantLevel = Random.Range(0, 3); break;
						case TerrainType.Sand:
							cell.PlantLevel = Random.Range(0, 2); break;
						default: cell.PlantLevel = 0; break;
					}					
				} else {
					int terrain;
